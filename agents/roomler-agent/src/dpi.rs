...
//!     CORPLAP-1 (1920×1200) on 2026-05-01.
//!
...
//! comparison). This closes the diagnostic loop for the CORPLAP-1 field
...
/// stored sentinel pointer values directly. CORPLAP-1 field test

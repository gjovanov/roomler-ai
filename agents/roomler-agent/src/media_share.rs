...
struct PipelineInner {
    ...
    /// field 2026-08-21, CORPLAP-3 — an av1_qsv driver hang froze the owner pump
...
impl Pipeline {
    ...
    /// 2026-08-20 (CORPLAP-2): owner=Sharper + follower=Smoother parked the
...
mod tests {
    ...
    async fn merged_refine_eligible_decision_table() {
        ...
        // THE field case (CORPLAP-2 2026-08-20): owner=Sharper +

...
///
/// rc.24 — was 1 MiB. CORPLAP-1 field repro showed sub-1-MiB files
...
///
/// **Why**: CORPLAP-1 field repro 2026-05-11 — ESET Security real-time
...
fn download_dir() -> Result<PathBuf> {
    ...
    // Field repro CORPLAP-1 rc.7 2026-05-06: file upload via browse-
    ...
    // Windows-specific final fallback (CORPLAP-1 2026-05-11 rc.20 field

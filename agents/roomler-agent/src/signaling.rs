...
/// the process watchdog kills the worker. Field case CORPLAP-1 2026-08-15
...
/// Pong-RTT degradation bound for the control WS. Field CORPLAP-1 2026-08-15
...
fn stub_caps(multi_org_tun: bool) -> AgentCaps {
    ...
    // a mesh that would fail its bring-up (field 2026-08-07, CORPLAP-1).
    if multi_org_tun {
...
mod tests {
    ...
    /// vote — the zombie-slow-WS detector (field CORPLAP-1 2026-08-15) only
    ...
    fn ws_send_timeout_fits_inside_the_watchdog_budget() {
        ...
        // the CORPLAP-1 2026-08-15 failure comes back: wedged send →

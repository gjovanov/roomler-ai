...
/// (pc50045): logon-screen transitions and Check-Point-VPN session flaps
...
///     dashboard (pc50045 logged several per day).
...
mod tests {
    ...
    /// the 60 s cap — the pc50045 multi-minute-outage class) but the respawn

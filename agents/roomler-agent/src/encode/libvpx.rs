...
/// Field-confirmed (CORPLAP-1 / CORPLAP-3, 2026-05-17).
///
...
impl Vp9Encoder {
    ...
    pub fn new_with_fps(width: u32, height: u32, target_fps: u32) -> Result<Self> {
        ...
        // encoder frame rate. Field-observed on CORPLAP-1 (rc.36): with
    ...
    /// (CORPLAP-1's Iris Xe is the field-validated case) where SW VP9
...
/// default to vbr after one field cycle on CORPLAP-1 confirms the

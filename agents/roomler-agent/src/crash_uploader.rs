...
/// CORPLAP-2: agent drained 1317 sidecars at ~50/sec, exhausted the
    ...
    Fut: std::future::Future<Output = String>,
{
    if status.is_success() {
        ...
        // repro 2026-05-17 CORPLAP-2: storm of 1317 sidecars hit the
...
mod tests {
    ...
    async fn classify_429_returns_transient_not_rejected() {
        // Field bug 2026-05-17 CORPLAP-2: 429 was being classified as

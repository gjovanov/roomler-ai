...
mod windows_version_info {
    ...
    /// `0.3.0-rc.448` -> `(0, 3, 448)`; a final release maps EXACTLY under
    /// the rolling `0.4.<counter>` scheme (2026-08-27): `0.4.485` ->
    /// `(0, 4, 485)`. Mirrors the MSI ProductVersion remap in

# FR-50 — roomlerd leaks unconnected ephemeral UDP sockets on the relay node

> Renumbered from FR-48 → FR-50 (2026-09-01): collided with #1083 "FR-48: installer cannot know which server handed it to you"; lower issue id keeps FR-48, so this (#1086) moved. FR-49 was #1084.

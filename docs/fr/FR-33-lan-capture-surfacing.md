...
(2026-09-04); P3 shipped in 0.4.61 + the 2026-09-04 UI deploy, field check NOT passed — blocked
by the viewer, see the field log: the operator's Edge (Chromium 152) gathers no host/srflx candidates at all,
so the agent never sees a LAN address to attribute; P3b (viewer-side attribution) proposed.**

...
| 3 | `PromptSurface` — 3.0 selection layer, 3.1 native Windows consent badge, 3.2 Tauri companion panels, 3.3 native X11, 3.4 native macOS | per-backend cargo feature; probe failure falls back | **3a (panels + LocalAPI verbs) implemented**; 3.1/3.3/3.4 not started |

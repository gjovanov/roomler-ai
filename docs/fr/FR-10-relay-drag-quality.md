...
- [ ] Field: CLK-from-neo16 drag no longer "bulky" (or clearly reduced); post-motion
...
| Release | Result |
|---|---|
| 0.4.5 (relay_idr_thrift) | shipped — field gate pending: CLK drag from neo16 (settle_kf_suppressed climbing, bytes_inflight lumps gone, bulky feel reduced) |

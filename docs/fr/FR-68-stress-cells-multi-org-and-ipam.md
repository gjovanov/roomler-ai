...
| CORPLAP-1 `pc50045` | `evicted=0 spared=0 waves=112 revalidations=10` |
| CORPLAP-3 `clk00017265` | `evicted=0 spared=0 waves=56 revalidations=9` |
...
pc50045 read `waves=112 revalidations=10`, then `waves=56 revalidations=0`

...
| [FR-22](FR-22-time-to-first-frame.md) | [#819](https://github.com/gjovanov/roomler-ai/issues/819) | Time-to-first-frame — connecting sometimes takes 10-15 s | investigated + fix proposed — agent side is 2.5-4.7 s and ICE is already trickled; the 15 s signalling timeout is the cost of one silently lost attempt |

...
| [FR-9](FR-9-lan-pairs-converge-direct.md) | [#768](https://github.com/gjovanov/roomler-ai/issues/768) | Two nodes sharing a LAN converge to a direct carrier | closed — all criteria met + field-verified on 0.4.2; renumbered from `FR-01` (lower issue id, #767 keeps FR-1); spec on master via PR #782 |
| [FR-10](FR-10-relay-drag-quality.md) | [#783](https://github.com/gjovanov/roomler-ai/issues/783) | Relay drag quality — IDR thrift on constrained transports | closed — shipped in 0.4.5, field PASS 2026-08-27 ("CLK from neo16 very smooth"); PC50045 residual attributed to DERP RTT; kept FR-10 by the lower-issue-id rule vs #784 |
...
| [FR-14](FR-14-direct-link-jitter-episodes.md) | [#792](https://github.com/gjovanov/roomler-ai/issues/792) | Direct-link jitter episodes — AIMD sawtooth on VPN-churning links | design — evidence collected (pc50045 2026-08-27); child of FR-1 |
| [FR-15](FR-15-relay-age-feedback.md) | [#795](https://github.com/gjovanov/roomler-ai/issues/795) | Relay age feedback — close the rate loop with the viewer's own clock | proposed — first age-pill field read localized the relay queue below the agent (DERP/TCP); child of FR-1 |

...
- *"When pc50045 connects to the corporate VPN, roomlerd gets restarted."*
...
pc50045 had four worker generations in 75 minutes, each rolling a fresh
direct-socket flow.
...
2. **Stage 1 — netd hosts the network plane** on opt-in hosts (pc50045

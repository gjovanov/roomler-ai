...
**Design + architecture**: `docs/remote-control.md` (16 sections covering goals, topology, protocol, data model, security, latency budget). Overlay-mesh sub-topics: `docs/agent-tunnel-architecture.md`, `docs/overlay-wfp.md` (Windows firewall override), **`docs/overlay-exit-nodes.md`** (Tailscale-style exit nodes).

...
- **Open**: P4 + P5 (browser auto-resume), P7 (UI polish), P8 (manual smoke on CORPLAP-1 — kill at 4/25/50/90%, auto-update mid-flight, sync_data perf re-measure), P9 (tag `agent-v0.3.0-rc.19`). Plan at `~/.claude/plans/floating-splashing-nebula.md`.

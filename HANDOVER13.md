...
3. Read `memory/project_input_regression_0_2_x.md` if validating the 0.2.7 hotfix on CORPLAP-1.
4. Confirm 0.2.7 is in the field via `roomler-agent --version` on CORPLAP-1 (auto-update should have rolled forward by then).

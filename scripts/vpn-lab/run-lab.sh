...
psexec "Get-Content '$RD\\roomler-samples.txt' -ErrorAction SilentlyContinue | Select-String -Pattern '=== |version|srflx|warm|CORPLAP-1|org:' | ForEach-Object { \$_.Line }" 90000 > "$OUT/pc-roomler-samples.txt"

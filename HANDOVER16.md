...
- **Pending phases**: P4-P5 (browser), P7 (UI polish), P8 (manual smoke on CORPLAP-1), P9 (tag agent-v0.3.0-rc.19)
...
Original: 35 MB xlsx upload from browser to CORPLAP-1 (Win11 perMachine) failed at 4 % (1,376,256/36,268,790 bytes), most likely from agent auto-update spawning msiexec mid-upload.
...
Field-test plan: after P4-P9 ship rc.19 in full, repeat the 35 MB xlsx upload + force kill on CORPLAP-1 and verify SHA match end-to-end.

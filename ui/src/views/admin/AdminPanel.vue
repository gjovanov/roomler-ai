<template>
  <v-container fluid class="pa-2 pa-md-4 pa-xl-6">
    ...
    <v-row>
      <v-col cols="12" md="3">
        <!-- Each section is a real route (admin-settings, admin-members,
             admin-roles, admin-tasks, admin-audit-log) so the URL reflects
             the active tab, browser back/forward works, and deep-links are
             bookmarkable. S4 pivot: the fleet/network sections moved to the
             top-level Devices page + Network group — old admin paths
             redirect there. -->

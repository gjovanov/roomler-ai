...
const KEYS: &[(&str, &str, &str)] = &[
    ...
    (
        ...
        "tribool",
        "P7 - idle refinement on Balanced+relay sessions (lifts the B1 physics cap at idle). Built-in default: on since P7c (field-proven on the CORPLAP-2 relay); off restores the un-refined Balanced rung. Env: ROOMLER_NODE_IDLE_REFINE_BALANCED. Restart required.",
    ),
    (
        "gpu_scale",
        "tribool",

...
mod system {
    ...
    /// org's block (pc50045: jovanov `100.65.0.5/22` inside grox's
    ...
    mod winaddr {
        ...
        /// hand-applied pc50045 mitigation lacked. Best-effort: geometry we
    ...
    impl SystemTun {
        ...
        pub fn add_address_sync(&self, ip: Ipv4Addr, prefix: u8) -> std::io::Result<()> {
            ...
            #[cfg(target_os = "windows")]
            {
                ...
                // the outer block's destinations (field 2026-08-09, pc50045).
    ...
    mod tests {
        ...
        /// source for ANY destination — pc50045's jovanov /22 inside grox's
        ...
        fn nesting_rule_matches_the_field_geometry() {
            ...
            // The pc50045 shape: the carved /22 nests inside the /10 — and

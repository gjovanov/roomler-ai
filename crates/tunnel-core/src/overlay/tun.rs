...
pub trait TunIo: Send + Sync {
    ...
    /// clk route war v3 (#23) — reclaim STOLEN per-peer forwarding paths.
    ///
    ...
    /// ours). Field (CLK00017265, 2026-08-18): four peers with healthy
...
mod system {
    ...
    mod winroute {
        ...
        /// clk route war v3 (#23) — does `row_net/row_plen` COVER `ip` (the
        ...
        /// clk route war v3 (#23) — evict every foreign v4 route that both
        ...
        /// clk route war v3 (#23) — the interface LUID the FIB would pick
        ...
        /// clk route war v3 (#23) — every in-block v4 destination whose
    ...
    /// clk route war v3 (#23) — the cache pin: one zero byte of UDP to
    ...
    mod tests {
        ...
        /// clk route war v3 (#23) — the reclaim's covering rule, and its

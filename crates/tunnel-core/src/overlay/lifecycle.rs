...
/// pc50045→neo16): our tx dead while the peer's own traffic keeps arriving —
...
///   pc50045 behind its corp VPN — every tier "installed", `roomler peers`
...
mod tests {
    ...
    fn carrier_stalled_matrix() {
        ...
        // The pc50045 shape: installed for ages, handshake never completed.

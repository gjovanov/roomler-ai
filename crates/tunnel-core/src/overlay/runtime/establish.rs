...
impl OverlayRuntime {
        ...
        for np in peers {
            ...
            match &self.mode {
                ...
                CarrierMode::Relay => {
                    ...
                    // rc.413's field probe on pc50045 found peers `blocked`
                    ...
                    // it directly: rc.414 on pc50045 + pc55331 logged
                    ...
                    // a time (pc50045: repeated "pinned UDP TURN allocate timed
    ...
    pub(super) async fn install_ready(
        ...
        if want_quic {
            ...
            // 90 s window. Field 2026-08-15 (pc50045 on VPN): health-sweep

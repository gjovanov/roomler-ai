...
//! every org that loses it (field: pc50045's second org re-punching after
...
impl CarrierPlane {
    ...
    /// lines in one day's log on pc50045. The task keeps its own low-rate
    /// heartbeat instead.
    async fn gather_via_sink(
        ...
        for server in targets.iter().take(3).copied() {
            ...
            // hosts is the ONLY path that passes UDP (field clk00017265
        ...
        let handle = tokio::spawn(async move {
            ...
            if state.punch.is_none() {
                ...
                loop {
                    ...
                    // 2026-08-14, pc50045 under Check Point emitted an
...
/// (field 2026-08-14: Check Point on pc50045 emitted one every ~6 s) would
...
mod tests {
    ...
    /// clk00017265 2026-08-15: AnyConnect filtered the physical NICs both

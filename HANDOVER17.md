# HANDOVER17 — rc.19 shipped (agent + browser); web deploy + CORPLAP-1 smoke pending
...
> workflow is mid-build. K8s web deploy + manual CORPLAP-1 smoke are
...
4. Run P8 smoke scenarios on CORPLAP-1.
